  ...
  return (
    <div className="m-sm-30">
      <div className="mb-sm-30">
        <Breadcrumb
          routeSegments={[{ name: 'Utilities', path: '/utilities' }, { name: 'Color' }]}
        />
      </div>
      <SimpleCard title="Background Color Class">
        ...
        <div className="bg-light-gray text-center py-24   w-100">.bg-light-gray</div>
        <div className="bg-secondary text-center text-white py-24 w-100">
          .bg-secondary
        </div>
        <div className="bg-light-primary text-center py-24 w-100">.bg-light-primary</div>
        <div className="bg-primary text-center text-white py-24 w-100">.bg-primary</div>
        <div className="bg-light-green text-center py-24 w-100">.bg-light-green</div>
        <div className="bg-green text-center text-white py-24 w-100">.bg-green</div>
        <div className="bg-light-error text-center py-24 w-100">.bg-light-error</div>
        <div className="bg-error text-center text-white py-24 w-100">.bg-error</div>
        <div className="bg-light-dark text-center py-24 w-100">.bg-light-dark</div>
      ...
      <SimpleCard title="Text Color Class">
        ...
        <div className="bg-primary text-center text-white py-24 w-100">.text-white</div>

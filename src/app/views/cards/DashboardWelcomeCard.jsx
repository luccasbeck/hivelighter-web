...
const DashboardWelcomeCard = ({ classes }) => {
  return (
    <Card elevation={3} className={`p-16 py-28 text-center h-100 w-100 ${classes.root}`}>
      <Fab color="primary" className="mb-28">
        <Icon>trending_up</Icon>
      </Fab>
      <div className="mb-38 font-size-18 uppercase text-white">welcome back! Watson</div>
